...
The original 40-case evaluation set is now DEV. The new source-grounded [holdout candidate package](docs/evaluation-v2.md) is pending human review and must not be retrieval-scored yet; see the [review sheet](docs/holdout-review.md).
